  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Manage all registered traders</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>All Traders</CardTitle>
          <CardDescription>{filtered.length} traders registered</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-4">
